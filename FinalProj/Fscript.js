let servings = 1;
calculatebutton =
  document.querySelector("#calculatebutton"); /*REQUIREMENT 9 queryselector 1*/
servingsInput =
  document.querySelector(".servings"); /*REQUIREMENT 9 queryselector 2*/

document
  .getElementById("calculatebutton")
  .addEventListener("click", ChangeServings); /*REQUIREMENT 8 eventlistener 1*/
...
//API Calling
let url = "https://corsproxy.io/?https://bored-api.appbrewery.com/random";
document
  .querySelector("#newapi")
  .addEventListener("click", fetchdata); /*REQUIREMENT 8 eventlistener 2*/
function fetchdata() {
...
let activityVue = Vue.createApp({
  /*EXTRA CREDIT 4 - lines 62-73 use vue*/
  data() {
    return {
